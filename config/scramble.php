...
return [
     ...
     * ],
     */
    // The whole API sits behind AuthenticateBasicOnce (see routes/api.php),
    // registered as the 'auth.basic.once' middleware -- not Laravel's
    // built-in 'auth'/'auth:*' patterns the default strategy looks for.
    'security_strategy' => [
        \Dedoc\Scramble\SecurityDocumentation\MiddlewareAuthSecurityStrategy::class,
        [
            'middleware' => ['auth.basic.once'],
            'scheme' => SecurityScheme::http('basic'),
        ],
    ],
];
