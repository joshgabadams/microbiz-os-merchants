...
cat > tests/Feature/AgentReconciliationServiceTest.php << 'MBOS_EOF'
<?php
...
echo "Agent reconciliation Part B applied (tests). Next: php artisan migrate --path=database/migrations/2026_08_13_000001_create_agent_reconciliations_table.php && php artisan test"
