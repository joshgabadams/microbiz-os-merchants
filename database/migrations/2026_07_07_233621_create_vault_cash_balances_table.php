...
return new class extends Migration
{
    ...
    {
        Schema::create('vault_cash_balances', function (Blueprint $table) {
    $table->id();
    ...
    $table->decimal('vault_deposits', 24, 2)->default(0);
    $table->decimal('vault_withdrawals', 24, 2)->default(0);
    $table->decimal('float_allocated', 24, 2)->default(0);
    ...
    $table->unique(['vault_id', 'business_date']);
    ...
    {
        Schema::dropIfExists('vault_cash_balances');
    }
};
