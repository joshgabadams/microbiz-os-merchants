...
@Component({
  ...
  styles: [`
    ...
    @media(max-width:520px){:host{right:.65rem;bottom:.65rem}.chat{width:calc(100vw - 1.3rem);height:calc(100dvh - 5.5rem)}.launcher{min-width:0}.launcher span{display:none}}
